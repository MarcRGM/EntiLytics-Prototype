...
def Page():
    ...
    solara.Style("""
        ...
        /* Toggle Button */
        .segmented-control .v-btn-toggle { background-color: #f0f0f0 !important; border-radius: 12px !important; padding: 4px !important; border-bottom: 6px solid #113F67 !important; }
